...
<html>
  <head>
    ...
    <script type="text/javascript" src="/js/deviceSimulator.js"></script>
    <link rel="stylesheet" type="text/css" href="css/jquery/jquery-ui.css"/>
    <link rel="stylesheet" type="text/css" href="css/common.css"/>
    <link rel="stylesheet" type="text/css" href="css/deviceSimulator.css"/>
    <meta charset="utf-8"> 
  </head>
 <body>
  ...
  <div id="app-nav-bar">
   ...
   <div id="backdrop">
     <iframe id="device-screen" class="ipad" src="/app.jsp"></iframe>
   </div>
 </body>
</html>
